...
/** @constructor */
function $c_Lmain_scala_JsEntry$() {
  $c_O.call(this)
}
$c_Lmain_scala_JsEntry$.prototype = new $h_O();
$c_Lmain_scala_JsEntry$.prototype.constructor = $c_Lmain_scala_JsEntry$;
/** @constructor */
function $h_Lmain_scala_JsEntry$() {
  /*<skip>*/
}
$h_Lmain_scala_JsEntry$.prototype = $c_Lmain_scala_JsEntry$.prototype;
$c_Lmain_scala_JsEntry$.prototype.init___ = (function() {
  return this
});
$c_Lmain_scala_JsEntry$.prototype.main$scala$JsEntry$$$anonfun$main$1__Lorg_scalajs_dom_raw_Event__Lorg_scalajs_dom_raw_XMLHttpRequest__O = (function(x$1, xhr$1) {
  if (($uI(xhr$1.status) === 200)) {
    var r = $g.JSON.parse($as_T(xhr$1.responseText));
    $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().console.info(r);
    return (void 0)
  } else {
    return (void 0)
  }
});
$c_Lmain_scala_JsEntry$.prototype.main__AT__V = (function(args) {
  var xhr = new $g.XMLHttpRequest();
  xhr.onload = (function(xhr$1) {
    return (function(arg1$2) {
      return $m_Lmain_scala_JsEntry$().main$scala$JsEntry$$$anonfun$main$1__Lorg_scalajs_dom_raw_Event__Lorg_scalajs_dom_raw_XMLHttpRequest__O(arg1$2, xhr$1)
    })
  })(xhr);
  (0, $m_Lorg_querki_jquery_package$().$$$1)("#btn").click($m_Lorg_querki_jquery_package$().f12EventHandler__F1__sjs_js_$bar(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, xhr$2) {
    return (function(x$2$2) {
      xhr$2.open("GET", "https://jsonplaceholder.typicode.com/todos/1");
      xhr$2.send();
      $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().alert("Hi")
    })
  })(this, xhr))))
});
var $d_Lmain_scala_JsEntry$ = new $TypeData().initClass({
  Lmain_scala_JsEntry$: 0
}, false, "main.scala.JsEntry$", {
  Lmain_scala_JsEntry$: 1,
  O: 1
});
$c_Lmain_scala_JsEntry$.prototype.$classData = $d_Lmain_scala_JsEntry$;
var $n_Lmain_scala_JsEntry$ = (void 0);
function $m_Lmain_scala_JsEntry$() {
  if ((!$n_Lmain_scala_JsEntry$)) {
    $n_Lmain_scala_JsEntry$ = new $c_Lmain_scala_JsEntry$().init___()
  };
  return $n_Lmain_scala_JsEntry$
}
/** @constructor */
...
$c_Lorg_querki_jquery_package$.prototype.f12EventHandler__F1__sjs_js_$bar = (function(func) {
  var a = (function(f) {
...
$m_Lmain_scala_JsEntry$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=firstapp-fastopt.js.map
